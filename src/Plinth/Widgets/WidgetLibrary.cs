...
/// widget folders, installs .plinthwidget packages (zip of manifest.json + index.html), and
...
public sealed partial class WidgetLibrary : IDisposable
{
    ...
    /// <summary>Installs a .plinthwidget package (a zip containing manifest.json + index.html at its root).</summary>
