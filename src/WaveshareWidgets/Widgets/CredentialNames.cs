...
public static partial class CredentialNames
{
    ...
    [GeneratedRegex(@"(^|[^a-z0-9])(token|secret|password|passwd|api ?key|bearer|pat|credential|private ?key|access ?key|authorization|auth ?header)s?([^a-z0-9]|$)", RegexOptions.IgnoreCase)]
