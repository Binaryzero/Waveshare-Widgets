# Licenses for the fonts vendored in this directory

Every family here is licensed under the SIL Open Font License 1.1. The per-family
copyright notices below and the license text that follows are reproduced verbatim
from the @fontsource packages these files were taken from, as the OFL requires of
